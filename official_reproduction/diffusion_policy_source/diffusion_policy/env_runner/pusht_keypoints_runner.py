...
class PushTKeypointsRunner(BaseLowdimRunner):
    def __init__(self,
        ...
        # Gym >=0.26 rejects shared-memory batching for the custom PushT
        # observation space used by this older upstream code. Pipe transfer is
        # slower but keeps evaluation behavior intact for compatibility smoke
        # runs in the current Python 3.12 container.
